...
{
	printf("Position in x : %lf \n", positionOnMap->x);
	printf("Position in y : %lf \n", positionOnMap->y);
	printf("Direction theta: %lf \n", positionOnMap->theta);
	printf("Linear speed : %lf \n", positionOnMap->dxdt);
	printf("Angular speed: %lf\n\n", positionOnMap->dthetadt);
}
...
{
	positionOnMap->dthetadt = positionOnMap->correctionRot*positionOnMap->wheels_radius 
	                            * (positionOnMap->delta_angle_L-positionOnMap->delta_angle_R) / (positionOnMap->distance_wheels);
}
...
{
	positionOnMap->dxdt = positionOnMap->correctionLin * positionOnMap->wheels_radius
	                        * (positionOnMap->delta_angle_R+positionOnMap->delta_angle_L) / 2;
}
