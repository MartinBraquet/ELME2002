...
void init_speed_controller(CtrlStruct* theCtrlStruct){
	...
	theCtrlStruct->theUserStruct->In = 1.1;
	theCtrlStruct->theUserStruct->Nn = 4370.0;
	theCtrlStruct->theUserStruct->Ra = 5.78;
	theCtrlStruct->theUserStruct->R = 0.03;
	//theCtrlStruct->theUserStruct->kphi = 0.0261;
	theCtrlStruct->theUserStruct->kphi = 0.0346;
	theCtrlStruct->theUserStruct->dt = 0.001;
	theCtrlStruct->theUserStruct->red = 19.0;
